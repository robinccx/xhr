  ...
  <div class="archive-title-container">
    <el-card shadow="hover">
      ...
      <el-table v-loading="loading" :data="tableData.data">
        <el-table-column label="院区" align="center" prop="areaId" :formatter="areaIdFormat" min-width="100px" />
        <el-table-column label="月份" align="center" prop="monthStr" min-width="100px" />
        <el-table-column label="月初人数" align="center" prop="startQty" min-width="80px" />
        <el-table-column label="离职" align="center" prop="leaveQty" min-width="80px" />
        <el-table-column label="转出" align="center" prop="outQty" min-width="80px" />
        <el-table-column label="入职" align="center" prop="newQty" min-width="80px" />
        <el-table-column label="转入" align="center" prop="inQty" min-width="80px" />
        <el-table-column label="增减人数" align="center" prop="addQty" min-width="100px" />
        <el-table-column label="月末人数" align="center" prop="endQty" min-width="100px" />
        <el-table-column label="离职人员名单" align="center" prop="leaveList" min-width="300px" />
      </el-table>
    </el-card>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const doQuery = () => {
      loading.value = true
      ListMonthlyTotal(state.tableData.param).then((res: any) => {
