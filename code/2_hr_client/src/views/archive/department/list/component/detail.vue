<template>
  <!-- 科室详情抽屉 -->  
  <div class="archive-department-detail">
    <el-drawer v-model="isShowDialog" size="80%" direction="ltr">
      ...
      <el-form ref="formRef" :model="formData" label-width="100px">          
        <el-row>        
          <el-col :span="12">          
            <el-form-item label="科室代码">{{ formData.deptCode }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="科室名称">{{ formData.deptName }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="负责人">{{ formData.leader }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="电话">{{ formData.phone }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="邮件">{{ formData.email }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
          ...
          <el-col :span="12">          
            <el-form-item label="片区">{{ formData.deptType }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="属性1">{{ formData.att1 }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="属性2">{{ formData.att2 }}</el-form-item>          
          </el-col>        
          <el-col :span="12">          
            <el-form-item label="属性3">{{ formData.att3 }}</el-form-item>          
          </el-col>      
        </el-row>      
      </el-form>
    </el-drawer>
...
<script lang="ts">
  ...
  export default defineComponent({
    name:"apiV1ArchiveDepartmentDetail",
    components:{      
    },
    props:{      
      statusOptions:{
    ...
    setup(props,{emit}) {      
      ...
      const state = reactive<DepartmentEditState>({
        ...
        // 打开弹窗
        const openDialog = (row?: DepartmentInfoData) => {
          resetForm();
          if(row) {
            getDepartment(row.deptId!).then((res:any)=>{
              const data = res.data;              
              let listUid = [];              
...
<style scoped>  
  .archive-department-detail :deep(.el-form-item--large .el-form-item__label){
    font-weight: bolder;
  }
  .pic-block{
    margin-right: 8px;
