...
export function listNurseImport(query:object) {
  return request({
    url: '/api/v1/system/nurseImport/list',
    method: 'get',
    params: query
  })
}
...
export function getNurseImport(nurseId:number) {
  return request({
    url: '/api/v1/system/nurseImport/get',
    method: 'get',
    params: {
...
export function addNurseImport(data:object) {
  return request({
    url: '/api/v1/system/nurseImport/add',
    method: 'post',
    data: data
  })
}
...
export function updateNurseImport(data:object) {
  return request({
    url: '/api/v1/system/nurseImport/edit',
    method: 'put',
    data: data
  })
}
...
export function delNurseImport(nurseIds:number[]) {
  return request({
    url: '/api/v1/system/nurseImport/delete',
    method: 'delete',
    data:{
      nurseIds:nurseIds
    }
