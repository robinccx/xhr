...
// 生成路径: internal/app/archive/model/t_education.go
// 生成人：xiao
// desc:学历
// company:云南奇讯科技有限公司
// ==========================================================================
...
// EducationInfoRes is the golang structure for table t_education.
type EducationInfoRes struct {
